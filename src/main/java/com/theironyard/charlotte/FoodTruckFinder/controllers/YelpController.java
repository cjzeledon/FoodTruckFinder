...
public class YelpController {
    ...
    // Draw in information from Yelp API.
    // Only needed this route for the front end to start working until the back end has
    // the database up and running, loaded with information
//    @CrossOrigin
...
//    }
    ...
    // Provide reviews of each food truck that is available on yelp
    // Food trucks WITHOUT reviews will not be available in json file
    // That is Yelp's decision, not ours.
    @CrossOrigin
